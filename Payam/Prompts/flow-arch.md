# Payam Phase 2 — Agent Implementation Brief

**For:** ClaudeIDE coding agent
**Project:** Payam iOS (SwiftUI, MVVM, iOS 17+)
...
- `PayamApp.swift` — add `BGTaskScheduler` registration
...
## Background Task Registration (PayamApp.swift)
