...
```
Payam/Models/ArticleState.swift
Payam/Models/UserPreferences.swift
Payam/Services/SyncService.swift
```
...
Create at `Payam/Models/ArticleState.swift`.
...
Create at `Payam/Models/UserPreferences.swift`.
...
Create at `Payam/Services/SyncService.swift`.
...
final class SyncService {
    ...
    /// Call this after the ModelContainer is created (in PayamApp.init or body).
...
5. Under CloudKit, ensure a container is selected (Xcode creates one automatically: `iCloud.DariusEhsani.Payam`)
