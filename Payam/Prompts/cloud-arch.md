...
Payam is built around a single guiding principle: **RSS is free and open, and the app experience should reflect that.**
...
The Payam cloud layer is a **serverless, event-driven backend** built entirely on AWS managed services. It is designed around three core constraints:
