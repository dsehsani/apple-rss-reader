...
struct AddFeedView: View {
    ...
    init(prefill: (feedURL: String, title: String)? = nil) {
        _viewModel = State(initialValue: AddFeedViewModel(prefill: prefill))
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: Design.Spacing.section) {
                        ...
                        // These sections slide in after a successful fetch (or immediately when prefilled)
            ...
            .navigationTitle(isPrefilled ? "Choose Folder" : "Add Feed")
