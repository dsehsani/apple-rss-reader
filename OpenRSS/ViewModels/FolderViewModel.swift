...
final class FolderViewModel {
    ...
    var filteredArticles: [Article] {
        ...
        return articles.sorted { a1, a2 in
            ...
            let hl1 = s1?.effectiveVelocityTier.halfLifeHours ?? VelocityTier.article.halfLifeHours
            let hl2 = s2?.effectiveVelocityTier.halfLifeHours ?? VelocityTier.article.halfLifeHours
